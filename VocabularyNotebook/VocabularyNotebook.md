...
| one by one | /wʌn baɪ wʌn/ 🔊 | 一个接一个地, 逐一地, 依次地 | The students entered the classroom one by one. (学生们一个接一个地走进教室。)<br>Please complete the tasks one by one to avoid mistakes. (请逐一完成这些任务以避免错误。) |